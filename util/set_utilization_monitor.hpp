...
public:
  ...
  virtual void start() override {   
    active = true; 
    std::cout << "SetUtilizationMonitor started." << std::endl;
  }
  virtual void stop() override { 
    active = false;
    std::cout << "SetUtilizationMonitor stopped." << std::endl;
  }
  ...
  virtual void reset() override {
    ...
    std::cout << "SetUtilizationMonitor has been reset." << std::endl;
  }
  ...
  void print_statistics(const std::string& cache_name = "") const {
    if (!cache_name.empty()) {
      std::cout << "\n========================================" << std::endl;
      std::cout << "=== " << cache_name << " Set Utilization generated by SetUtilizationMonitor ===" << std::endl;
      std::cout << "========================================" << std::endl;
    }
